...
export default function DeleteUser({ id }: DeleteUserProps) {
        ...
        toast.custom(
            (t) => (
                <div className="p-4 rounded-md shadow-md bg-destructive text-white border border-destructive max-w-md mx-auto w-full space-y-4">
                    ...
                    <p className="text-sm opacity-90">L’utente sarà eliminato a meno che non annulli entro 10 secondi.</p>
                    <button
    ...
    return (
        <Button className="custom-button !text-sm grow" variant="destructive" onClick={() => handleToast(id)}>
            <Trash />
        </Button>
    )
}